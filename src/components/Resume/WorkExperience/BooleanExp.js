  ...
  return (
    <div className="boolean-exp">
			...
			<ul>
				...
				<li>
					Front-end project: Recreated a shop platform using HTML, CSS, React,
					and JavaScript.
				</li>
				<li>
					Back-end project: Developed a movie tracker app utilising React, CSS,
					Prisma, PostgreSQL, and Node.js
				</li>
